...
class ModelManager(metaclass=Singleton):
    ...
    def init_models(self, use_local_proxy: bool = False):
        ...
        self._register_alibaba_models(use_local_proxy=True)
    ...
    def _register_alibaba_models(self, use_local_proxy: bool = False):
        # qwen2.5-32b-instruct
        if use_local_proxy:
            logger.info("Using local proxy for Qwen models")
            api_key = self._check_local_api_key(local_api_key_name="SKYWORK_ALI_API_KEY",
                                                remote_api_key_name="ALI_API_KEY")
            # qwen2.5-32b-instruct
            model_name = "ali_qwen2.5-32b-instruct"
            ...
            api_key = self._check_local_api_key(local_api_key_name="ALI_API_KEY",
                                                remote_api_key_name="ALI_API_KEY")
            api_base = self._check_local_api_base(local_api_base_name="ALI_API_BASE",
                                                  remote_api_base_name="ALI_API_BASE")
